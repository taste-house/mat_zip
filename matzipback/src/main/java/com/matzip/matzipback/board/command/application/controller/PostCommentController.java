...
public class PostCommentController {
    ...
    public ResponseEntity<Long> deletePostComment(@PathVariable Long postCommentSeq) {
        return ResponseEntity.ok(postCommentService.deletePostComment(postCommentSeq));
    }
